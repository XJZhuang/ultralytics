...
'''
@Project ：1_Python 
@File    ：01_val_switchgear.py
@Author  ：DELL(zhuangxujun)
@Date    ：2025/10/11 8:58 
@explain : 
'''
...
if __name__ == '__main__':
    ...
    # Load a model
    model = YOLO("/home/zxj/ultralytics-switchgear/01_train_scripts/switchgear/train4/weights/best.pt")

    # Customize validation settings
    metrics = model.val(
        data="../ultralytics/cfg/datasets/switchgear.yaml",
        imgsz=640,
        batch=32,
        # conf=0.25,
        # iou=0.6,
