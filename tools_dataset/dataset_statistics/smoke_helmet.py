...
def print_statistics(all_stats, class_names):
    ...
    类别总实例分布:
      light: 2417 个实例，出现在 645 张图片中
      knob: 1388 个实例，出现在 653 张图片中
      pointer: 407 个实例，出现在 337 张图片中
      switch: 836 个实例，出现在 181 张图片中
      breaker: 287 个实例，出现在 279 张图片中
      liquid: 45 个实例，出现在 45 张图片中
    ...
    类别总实例分布:
      light: 657 个实例，出现在 162 张图片中
      knob: 361 个实例，出现在 165 张图片中
      pointer: 110 个实例，出现在 90 张图片中
      switch: 252 个实例，出现在 52 张图片中
      breaker: 59 个实例，出现在 56 张图片中
      liquid: 12 个实例，出现在 12 张图片中
    ...
    类别总实例分布:
      light: 3074 个实例，出现在 807 张图片中
      knob: 1749 个实例，出现在 818 张图片中
      pointer: 517 个实例，出现在 427 张图片中
      switch: 1088 个实例，出现在 233 张图片中
      breaker: 346 个实例，出现在 335 张图片中
      liquid: 57 个实例，出现在 57 张图片中
