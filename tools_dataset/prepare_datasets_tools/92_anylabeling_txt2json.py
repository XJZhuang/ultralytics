...
@File    ：92_anylabeling_txt2json.py
@Author  ：zhuangxujun
@Date    ：2025/4/23 14:19 
@explain : 
'''
import argparse
import json
...
def main():  # noqa: C901
    ...
    parser.add_argument(
        "--task", default="rectangle",
        choices=["rectangle", "polygon", "rotation", "mots"], help="Choose the type of task to perform",
    )

    parser.add_argument("--src_path",
                        default=r"D:\1_python\datasets\0_detect_safety\labels\train_shoes",
                        help="Path to input file or directory")
    parser.add_argument("--dst_path", default=r"D:\1_python\datasets\0_detect_safety\labels_json\train_shoes",
                        help="Path to output file or directory")
    parser.add_argument("--img_path", default=r"D:\1_python\datasets\0_detect_safety\images\train_shoes",
                        help="Path to image file or directory")
    parser.add_argument(
        "--classes", default=r"D:\1_python\datasets\0_detect_safety\labels\train_shoes\classes.txt",
